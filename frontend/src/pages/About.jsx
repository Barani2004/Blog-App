...
function About() {
  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <br />
      <span>
        Barani A is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        Beyond his professional achievements, Barani is a big fan of cricket and
        holds immense admiration for <strong> King Kohli.</strong> His favorite
        person and biggest inspiration is her sister,{" "}
        <strong>Abi.</strong> Their friendly rivalry and deep bond have
        significantly shaped Barani’s journey. Abi is not only a great
        competitor but also a steadfast friend, constantly motivating barani to
